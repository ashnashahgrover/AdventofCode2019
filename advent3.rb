...
def line(instructions)
  ...
  instructions.each do |instruction|
    ...
    if (instruction[0]=="R")
      right = line1points.last[0] + instruction[1..size-1].to_i
      new = [right, line1points.last[1]]
      line1points.push(new)
    elsif (instruction[0]=="L")
      left = line1points.last[0] - instruction[1..size-1].to_i
      new = [left, line1points.last[1]]
      line1points.push(new)
    elsif (instruction[0]=="U")
      up = line1points.last[1] + instruction[1..size-1].to_i
      new = [line1points.last[0],up]
      line1points.push(new)
    elsif (instruction[0]=="D")
      down = line1points.last[1] - instruction[1..size-1].to_i
      new = [line1points.last[0],down]
      line1points.push(new)
    else
      nil
    end
...
line1points = line(line1)
line2points = line(line2)

f = File.new('set1.txt', 'w')
f.write(line1points)
f.close
...
#   final_points = []
#   for i in (0..line1points.size-1) do
#     if line1points[i]==line2points[i]
#       final_points.push(line1points[i])
#     end
#   end
# end
#
# intersect(line1points,line2points)
#
